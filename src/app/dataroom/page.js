              ...
              <div className="flex items-center space-x-2">
                {['all', 'rooms', 'documents', 'users'].map((filter) => (
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-sm font-medium transition-colors ${searchFilter === filter
                        ...
                        <div key={index} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-slate-500 mt-0.5">
                              {activity.details?.name || activity.details?.fileName || activity.resourceType} • {activity.userEmail || activity.userName || 'System'}
                            </p>
                          </div>
