...
// GET /api/changelogs/unseen — the single latest published changelog the
// current user hasn't acknowledged yet (server-side seen-tracking, so it's
// consistent across the user's devices). Returns { changelog: null } if
// there's nothing new. The client decides how to present it based on its
// displayMode (banner/popup/forced/full_page).
