// src/app/api/resources/[id]/view/route.js
 ...
 * Stream a file from GridFS for viewing
 */
export async function GET(req, { params }) {
  try {
    ...
    // For interns, check download restrictions
    ...
    return new Promise((resolve) => {
      ...
      downloadStream.on('error', (error) => {
        resolve(
          NextResponse.json({ error: "Failed to stream file", details: error.message }, { status: 500 })
        );
      });
    });
