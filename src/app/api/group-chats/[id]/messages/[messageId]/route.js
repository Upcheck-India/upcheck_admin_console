...
export async function PATCH(request, { params }) {
  try {
    ...
    const message = await db.collection('group_chat_messages').findOne({ _id: new ObjectId(messageId) });
    if (!message) {
    ...
    const updateRes = await db.collection('group_chat_messages').findOneAndUpdate(
